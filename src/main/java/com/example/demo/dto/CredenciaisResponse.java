...
public class CredenciaisResponse {
    ...
    public CredenciaisResponse(Long id, UUID uuid, String company, String senha, Boolean favoritos, String iv1, String iv2, String iv3, String email, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.uuid = uuid;
